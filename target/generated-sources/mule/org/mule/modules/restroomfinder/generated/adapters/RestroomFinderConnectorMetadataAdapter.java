...
/**
 * A <code>RestroomFinderConnectorMetadataAdapter</code> is a wrapper around {@link RestroomFinderConnector } that adds support for querying metadata about the extension.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.9.0", date = "2017-08-26T02:49:12-04:00", comments = "Build UNNAMED.2793.f49b6c7")
public class RestroomFinderConnectorMetadataAdapter
    extends RestroomFinderConnectorCapabilitiesAdapter
    implements MetadataAware
{

    private final static String MODULE_NAME = "RestroomFinder";
